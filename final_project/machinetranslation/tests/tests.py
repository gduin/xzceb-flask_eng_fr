...
class translator_test(unittest.TestCase):
    ...
    def test_e2f(self):
        ...
        self.assertNotEqual( translator.translate_english_to_french(self.english_text), self.english_text)

    def test_f2e(self):
        
        self.assertEqual( translator.translate_french_to_english(self.french_text), self.english_text)
        self.assertNotEqual( translator.translate_french_to_english(self.french_text), self.french_text)
